...
export default function AllGames() {
  ...
  let {Data , isLoading} = useApi(`https://free-to-play-games-database.p.rapidapi.com/api/games`) ;
  const [visible, setVisible] = useState(20);
  let displayMore = () => setVisible((prevValue) => prevValue + 20);
  return (
    <div id="allGames">
        ...
        <div className="row g-3 my-4">
          {!isLoading ? (
            ...
            <div className="text-center">
              <SpinnerRoundFilled size={200} color={"#0DC3E7"} />
            </div>
          )}
        </div>
